...
source $tools/merqury/util/util.sh
...
asm1=`echo $asm1_fa | sed 's/.fasta.gz//g' | sed 's/.fa.gz//g' | sed 's/.fna.gz//g' | sed 's/.fna//g' | sed 's/.fasta//g' | sed 's/.fa//g'`
for asm_fa in $asm1_fa $asm2_fa
do
        asm=`echo $asm_fa | sed 's/.fasta.gz//g' | sed 's/.fa.gz//g' | sed 's/.fna.gz//g' | sed 's/.fna//g' | sed 's/.fasta//g' | sed 's/.fa//g'`
...
asm2=`echo $asm2_fa | sed 's/.fasta.gz//g' | sed 's/.fa.gz//g' | sed 's/.fna.gz//g' | sed 's/.fna//g' | sed 's/.fasta//g' | sed 's/.fa//g'`
